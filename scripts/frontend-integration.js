 ...
 * This file demonstrates how to integrate Web3drift with a web frontend
 */

// For React/Vue/Angular applications
export class Web3driftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3driftClient(provider, contractAddress);
